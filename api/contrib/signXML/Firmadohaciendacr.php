...
class Firmadocr
{
    const VERSION_ESQUEMAS = "4.2";
    
    const NODOS_NS = [
        "4.2" => [
            "URL" => "https://tribunet.hacienda.go.cr/docs/esquemas/2017/v4.2/",
    ...
    public function insertaFirma($xml)
    {
        ...
        $xmlns_keyinfo = 'xmlns="'.self::NODOS_NS[self::VERSION_ESQUEMAS]["URL"].self::NODOS_NS[self::VERSION_ESQUEMAS][$this->tipoDoc].'" ';
